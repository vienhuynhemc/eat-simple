...
public class GetSoSao {
    ...
    public static void getData(Context context, String ma_sp, TextView tv,LoadProductViewAdapter adapter){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, urlLoad,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                            ...
                            tv.setText(String.valueOf( (double) Math.round(sosao * 10) / 10));
