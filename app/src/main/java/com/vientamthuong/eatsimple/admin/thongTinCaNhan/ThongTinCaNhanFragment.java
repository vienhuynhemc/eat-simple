package com.vientamthuong.eatsimple.admin.thongTinCaNhan;
...
public class ThongTinCaNhanFragment extends Fragment implements MainFragment {

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.admin_fragment_thong_tin_ca_nhan_home, container, false);
        return view;
    }
